...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void add(Specification specification) {
		...
		// 设置规格ID
		for (TbSpecificationOption so : specification.getSpecOptionList()) {
	...
	public void update(Specification specification){
		...
		//获取规格选项集合
		List<TbSpecificationOption> specificationOptionList = specification.getSpecOptionList();
	...
	public Specification findOne(Long id){
		...
		//设置规格选项
		specification.setSpecOptionList(specificationOptionList);
